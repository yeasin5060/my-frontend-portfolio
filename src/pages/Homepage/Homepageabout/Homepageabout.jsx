        ...
        <div className='container'>
          <div className='homeabout_wrapper'>
            ...
            <div className='homeabot_wrapper_contant_box'>
              ...
              <Heading level="p" text="Hey, my name is Yeasin, and I'm a Frontend Developer.I'm 21 year old. I'm learning HTML , CSS , SASS , TAILWINd , REACT , JAVASCRIPT for front-end or NODE.JS , MONGO.DB , JAVASCRIPT for back-end. " style="homeabot_wrapper_contant_pera"/>
